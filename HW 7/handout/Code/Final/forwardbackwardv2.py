# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 21:55:40 2018
...
def argmax(t, sentence):
    ...
    if t == len(sentence)-1 and t>=4:
#        sumlog = 0
##        sumalphabeta = 0
#        for qxq in range(len(dic_labels)):
#            sumlog += alpha(qxq, t, sentence, dic_a)
#        blahblah.append(sumlog)
        for qxw in range(len(dic_labels)):
            blablacar.append(alpha(qxw, 4, sentence, dic_a)>=beta(qxw, 4, sentence, dic_b))
...
#print(sum(blahblah)/len(blahblah))
