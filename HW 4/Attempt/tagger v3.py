...
def outputfinal(likt1,likv1,likt2,likv2,trn_err,tst_err,file):
    with open(file, 'w') as f:
        f.write("epoch=1 likelihood(train): "+str(likt1)+"\n")
        f.write("epoch=1 likelihood(validation): "+str(likv1)+"\n")
        f.write("epoch=2 likelihood(train): "+str(likt2)+"\n")
        f.write("epoch=2 likelihood(validation): "+str(likv2)+"\n")
...
if check_num == 1:
    ...
    yo1 = tsvtomatrix("validation.tsv")
    yo2 = tsvtomatrix("test.tsv")
    lbll,lbid,atid,dix,dout = matrixtoform(yo)
    a = np.zeros((len(lbid), len(atid)+1))
    a = start_train1(yo, lbid, atid, 0.5, a)
    likt11 = negloglik1(yo, a, atid, lbid)
    likv11 = negloglik1(yo1, a, atid, lbid)
    a = start_train1(yo, lbid, atid, 0.5, a)
    likt12 = negloglik1(yo, a, atid, lbid)
    likv12 = negloglik1(yo1, a, atid, lbid)
    ...
    outputfinal(likt11,likv11,likt12,likv12,trn_err,tst_err,"model1metrics_out.txt")
#    trn_err = output_trn1
#    tst_err = output_tst1
#    output_err
...
if check_num == 2:
    ...
    likt21 = negloglik2(yo, a2, atid2, lbid2)
    likv21 = negloglik2(yo1, a2, atid2, lbid2)
    a2 = start_train2(yo, lbid2, atid2, 0.5, a2)
    likt22 = negloglik2(yo, a2, atid2, lbid2)
    likv22 = negloglik2(yo1, a2, atid2, lbid2)
    ...
    outputfinal(likt21,likv21,likt22,likv22,trn_err2,tst_err2,"model2metrics_out.txt")
#    trn_err = output_trn2
#    tst_err = output_tst2
#    output_err
