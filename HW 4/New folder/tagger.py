...
check_num = int(args.feature_flag)

if check_num == 1:
    yo = tsvtomatrix(args.train_input)
    yo1 = tsvtomatrix(args.validation_input)
    yo2 = tsvtomatrix(args.test_input)
    ...
    trn_err = output_lbl1(yo, a, lbid, atid, lbll, args.train_out)
    tst_err = output_lbl1(yo2, a, lbid, atid, lbll, args.test_out)
    outputfinal(likt1,likv1,trn_err,tst_err,num_epoch,args.metrics_out)
#    trn_err = output_trn1
#    tst_err = output_tst1
#    output_err
...
if check_num == 2:
    ...
    trn_err2 = output_lbl2(yo, a2, lbid2, atid2, lbll2, args.train_out)
    tst_err2 = output_lbl2(yo2, a2, lbid2, atid2, lbll2, args.test_out)
    outputfinal(likt2,likv2,trn_err2,tst_err2,num_epoch,args.metrics_out)
#    trn_err = output_trn2
#    tst_err = output_tst2
#    output_err
