...
recur(root,0,5,csvtomatrix("small_train.csv"),[])
...
trainerr = err_output_write(root,csvtomatrix("small_train.csv"), "check.txt")
#print(trainerr)

testerr = err_output_write(root,csvtomatrix("small_test.csv"), "check1.txt")
#
