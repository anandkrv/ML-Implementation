...
#test out
#metrics out
# Q1 root separate as check in recur
...
recur(root,0,0,csvtomatrix("politicians_train.csv"),[])
...
trainerr = err_output_write(root,csvtomatrix("politicians_train.csv"), "check.txt")
#print(trainerr)

testerr = err_output_write(root,csvtomatrix("politicians_test.csv"), "check1.txt")
#
